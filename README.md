...
- [x] __20:__ GET requests to the `/api/supported-operations` route responds with JSON content, as described in the example above
- [x] __80:__ POST requests to the `/api/compute` route maths the two numbers provided in the request body and responds with the result. An invalid operator should return a 404.
